...
Pod::Spec.new do |s|
  ...
  # Dependencies for old architecture only (codegen/new arch disabled)
  if respond_to?(:install_modules_dependencies, true)
    install_modules_dependencies(s)
  else
    s.dependency "React-Core"
    # Codegen-related dependencies are intentionally omitted to disable new architecture support
  end
